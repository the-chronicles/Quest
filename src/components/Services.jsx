  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center font-[Inter]">
        <div className="w-fit items-center justify-center text-xs md:text-sm rounded-full border-2 border-[#CFD3EF] bg-[#FAFAFD] px-2 py-1 md:px-4 md:py-2 uppercase text-[#747999]">
          Here Always
        </div>
        <div className="text-center">
          {/* <h1 className="mb-4 mt-5 font-semibold text-[#060E23] text-2xl md:text-6xl">
            24/7 support to help you with <br />
            anything
          </h1> */}

          <div className="mb-4 mt-5 text-center font-semibold font-[Inter] text-2xl   text-[#060E23] md:text-6xl">
    ...
    <span className="block">anything</span>
          ...
          <div className="grid grid-cols-1 gap-4 p-5 text-center md:grid-cols-2">
            <div class="flex h-[217px] flex-col items-center justify-start gap-[33px] border-t border-b md:border-l md:border-t-0 md:border-b-0 md:border-r border-[#f8f9fb] px-8 py-10">
            ...
            <div class="flex h-[217px] flex-col items-center justify-start gap-[33px] border-t border-b md:border-t-0 md:border-b-0 md:border-l md:border-r border-[#f8f9fb] px-8 py-10">
              <div class="relative h-8 w-8">
